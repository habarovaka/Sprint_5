...
class TestStellarBurgersLogin:
    ...
    def test_login_from_main_page(self, driver, registered_user, login_user):
    ...
    def test_login_personal_cabinet_button_success(self, driver, registered_user, login_user):
        driver.get(Urls.BASE_URL)
    ...
    def test_login_from_registration_form_success(self, driver, registered_user, login_user):
    ...
    def test_login_from_forgot_password_form_success(self, driver, registered_user, login_user):
